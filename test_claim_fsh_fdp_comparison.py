...
dag = DAG(
    'test_claim_fsh_fdp_comparison', default_args=default_args, schedule_interval=None)

t1 = BashOperator(
    task_id='claim_fsh_fdp_comparison_test',
    bash_command='git clone https://github.com/Direct-Line-Group/fint-testing.git; '
                 ...
                 'python utils/FSH_FDP_Comparison_claims.py;'
