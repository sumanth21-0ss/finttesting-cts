...
dag = DAG(
    'test_claimscontract_mapping', default_args=default_args, schedule_interval=None)
...
t1 = BashOperator(
    ...
    bash_command='git clone https://github.com/Direct-Line-Group/fint-testing.git; '
                 ...
                 'python -m pytest tests/claims_dap_fdp_integration/test_claims_mapping.py;'
                 'aws s3 cp reports s3://fdp-test-automation-reports-test/claims/mapping --recursive',
    retries=0,
    dag=dag)
