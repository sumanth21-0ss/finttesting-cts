...
dag = DAG(
    'test_claimscontract_singlequery', default_args=default_args, schedule_interval=None)

t1 = BashOperator(
    task_id='claims_contract_test',
    bash_command='git clone https://github.com/Direct-Line-Group/fint-testing.git; '
                 ...
                 'python -m pytest tests/claims_dap_fdp_integration/test_claims_singlequery.py;'
                 'aws s3 cp reports s3://fdp-test-automation-reports-test/claims/singlequery --recursive',
    retries=0,
    dag=dag)
