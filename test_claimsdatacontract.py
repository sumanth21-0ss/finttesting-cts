...
dag = DAG(
    'test_claimsdatacontract', default_args=default_args, schedule_interval=None)

t1 = BashOperator(
    task_id='claims_data_contract_test',
    bash_command='git clone https://github.com/Direct-Line-Group/fint-testing.git; '
                 ...
                 'python -m pytest tests/claims_dap_fdp_integration/test_claims_datacontract.py;'
                 'aws s3 cp reports s3://fdp-test-automation-reports-test/claims/datacontract/ --recursive',
    retries=0,
    dag=dag)
