...
dag = DAG(
    'test_insurancecontract_redshift_mapping', default_args=default_args, schedule_interval=None)

t1 = BashOperator(
    task_id='insurance_contract_redshift_mapping_test',
    bash_command='git clone https://github.com/Direct-Line-Group/fint-testing.git; '
                 ...
                 'python -m pytest tests/insurance_aurora_redshift_integration/test_ins_redshift_psicle_mapping.py;'
