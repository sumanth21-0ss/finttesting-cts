...
dag = DAG(
    'test_insurancedatacontract', default_args=default_args, schedule_interval=None)

t1 = BashOperator(
    task_id='insurance_data_contract_test',
    bash_command='git clone https://github.com/Direct-Line-Group/fint-testing.git; '
                 ...
                 'python -m pytest tests/insurance_dap_fdp_integration/test_ins_datacontract.py;'
                 'aws s3 cp reports s3://fdp-test-automation-reports-test/insurance/datacontract/ --recursive',
    retries=0,
    dag=dag)
