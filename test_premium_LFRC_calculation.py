...
dag = DAG(
    'test_premium_LFRC_calculation', default_args=default_args, schedule_interval=None)

t1 = BashOperator(
    task_id='premium_LFRC_calculation_test',
    bash_command='git clone https://github.com/Direct-Line-Group/fint-testing.git; '
                 ...
                 'python -m pytest tests/premium_fdp_integration/test_premium_calculation.py -n 15;'
                 'aws s3 cp reports s3://fdp-test-automation-reports-test/premium/premiumcalculation --recursive',
    retries=0,
    dag=dag)