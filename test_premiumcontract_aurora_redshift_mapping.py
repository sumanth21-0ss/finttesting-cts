...
dag = DAG(
    'test_premiumcontract_aurora_redshift_mapping', default_args=default_args, schedule_interval=None)

t1 = BashOperator(
    task_id='premium_contract_aurora_redshift_test',
    bash_command='git clone https://github.com/Direct-Line-Group/fint-testing.git; '
                 ...
                 'python -m pytest tests/premium_aurora_redshift_integration/test_premium_redshift_mapping.py;'
                 'aws s3 cp reports s3://fdp-test-automation-reports-test/premium/mapping_redshift --recursive',
    retries=0,
    dag=dag)
