...
dag = DAG(
    'test_premiumdatacontract', default_args=default_args, schedule_interval=None)

t1 = BashOperator(
    task_id='premium_data_contract_test',
    bash_command='git clone https://github.com/Direct-Line-Group/fint-testing.git; '
                 ...
                 'python -m pytest tests/premium_fdp_integration/test_premium_datacontract.py;'
                 'aws s3 cp reports s3://fdp-test-automation-reports-test/premium/datacontract --recursive',
    retries=0,
    dag=dag)
